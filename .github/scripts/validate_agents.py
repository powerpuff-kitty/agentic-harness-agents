...
for pattern in ['test_adapter_assets.py', 'test_skill_bundles.py', 'test_guidance_efficiency.py',
                'test_guidance_comparison.py', 'test_guidance_series.py', 'test_codex_usage.py',
                'test_codex_usage_lifecycle.py', 'test_skill_entrypoints.py', 'test_context_scope.py',
                'test_guidance_trial.py', 'test_guidance_series_preparation.py', 'test_guidance_trial_staging.py',
                'test_lifecycle_guidance.py', 'test_migration_guidance.py', 'test_conditional_guides.py',
                ...
                'test_python_outline.py', 'test_python_outline_distribution.py',
                'test_typescript_outline.py', 'test_typescript_outline_distribution.py',
