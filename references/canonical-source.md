...
Canonical `catalog/context/profiles.v1.json` and `.agentic/docs/project/context-selection-v1.md` own full/minimal file selection. This is independent of organization profiles. Check installed CLI support before using the option; switching context profiles never authorizes file deletion or replacing project-owned routes. Host adapters remain separately selected in minimal mode.
