...
The five enrolled bundles are `codebase-audit`, `security-review`, `design-system-compliance`, `agentic-improvement` and `decision-intelligence`. Four retain documentation-only v1 declarations; agentic-improvement uses an explicit optional-script v2 declaration. Review procedures advance agents #25; the two guidance bundles advance #32/#36. Enrollment is not publication, installation or proof of host loading.
