...
Before changing a skill or prompt that depends on boilerplates, packs, policies, profiles, presets, schemas, or architecture, consult `https://github.com/powerpuff-kitty/agentic-harness` and treat it as the main source of truth.
